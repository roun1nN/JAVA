...
public class ManagementFeeOutput {
...
//    @ExcelProperty("外卖虚收")
    ...
    public ManagementFeeOutput() {
    }

    public ManagementFeeOutput(String sequence, String storeCode, String storeName, String businessDate, Double businessAmount,
